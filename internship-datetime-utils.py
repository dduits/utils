...
# Get the amount of hours for the internship.
...
week_hours = input("Amount of hours a week: \n> ").strip()
...
# Add extra weeks if required.
if extra_weeks:
    extra_weeks = int(extra_weeks)
    weeks = weeks + extra_weeks

# Calculate the end date and print the result.
